import { ChevronDown, ChevronRight, Ellipsis, Search, X, type LucideIcon, type LucideProps } from "lucide-react"
    ...
    Category: (props: LucideProps) => (
        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g stroke="none" strokeWidth="1.5" fill="none" fillRule="evenodd">
                <g id="Category" transform="translate(2.000000, 2.000000)" fill="currentColor" fillRule="nonzero">
